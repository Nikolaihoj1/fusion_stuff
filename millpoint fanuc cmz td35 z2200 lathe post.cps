...
description = "DR 22 CMZ - MillPoint.DK Post edit";
vendor = "MillPoint.DK";
vendorUrl = "https://www.www.millpoint.dk";
legal = "MillPoint.dk";
certificationLevel = 2;
minimumRevision = 45909;

longDescription = "DR 22 CMZ - MillPoint.DK Post edit";
...
*/
  case "ENABLE_C_AXIS":
    ...
    return (spindle == SPINDLE_MAIN) ? 80 : 135;
  case "DISABLE_C_AXIS":
    machineState.cAxisIsEngaged = false;
    return (spindle == SPINDLE_MAIN) ? 81 : 134;
  ...
  case "LOCK_MULTI_AXIS":
    return (spindle == SPINDLE_MAIN) ? 50 : 189;
  case "UNLOCK_MULTI_AXIS":
    return (spindle == SPINDLE_MAIN) ? 51 : 190;
  case "CLAMP_CHUCK":
...
function getToolOffsetFactor(tool) {
  return 1000; // always use 3-digit offsets
}
